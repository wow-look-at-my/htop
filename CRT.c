...
static int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [HUGEPAGE_THP] = ColorPair(Magenta, Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [HUGEPAGE_THP] = ColorPair(Magenta, White),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [HUGEPAGE_THP] = A_BOLD | ColorPair(Magenta, Blue),
   ...
   [COLORSCHEME_NORD] = {
      ...
      [HUGEPAGE_THP] = A_BOLD | ColorPair(Magenta, Black),
